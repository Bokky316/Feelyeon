...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        /*
            ...
            *    시큐리티가 인증이 필요하게 되면 /members/login 을 요청하게 된다.
            ...
            *  - 로그인 페이지에서 로그인을 시도할때 반드시 POST 방식으로 전송해야 한다. 비록 컨트롤러에는
        ...
        http .authorizeRequests(request -> request
                .requestMatchers("/images/**", "/static-images/**", "/css/**", "/favicon.ico", "/error", "/img/**").permitAll()// 여기 설정된 정적리소스 URL은 인증 없이 접근 가능
